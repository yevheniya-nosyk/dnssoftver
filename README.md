...
| [Technitium DNS Server](https://technitium.com/dns/) | Recursive | `8.0-8.1.4`, `9.0-9.1`, `10.0-10.0.1`, `11.0-11.4.1` | Docker | <ul><li>[Source code](https://download.technitium.com/dns/archive/)</li><li>[CHANGELOG](https://github.com/TechnitiumSoftware/DnsServer/blob/master/CHANGELOG.md)</li></ul> |
